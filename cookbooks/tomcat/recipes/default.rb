...
node['tomcat']['instances'].each do |name, attrs|
  tomcat_instance "#{name}" do
    ...
    jndi_datasource_name attrs['jndi_datasource_name']
    jndi_driver attrs['jndi_driver']
    jndi_connection_string attrs['jndi_connection_string']
    jndi_user attrs['jndi_user']
    jndi_password attrs['jndi_password']
    jndi_max_active attrs['jndi_max_active']
    jndi_max_idle attrs['jndi_max_idle']
    jndi_max_wait attrs['jndi_max_wait']
  end
end
