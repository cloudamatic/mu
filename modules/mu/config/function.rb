    ...
    class Function
      ...
      def self.schema
      {
        ...
        "properties" => {
          ...
          "runtime" => {
            "type" => "string",
            "enum" => %w{nodejs nodejs4.3 nodejs6.10 nodejs8.10 java8 python2.7 python3.6 python3.7 python3.8 dotnetcore1.0 dotnetcore2.0 dotnetcore2.1 nodejs4.3-edge go1.x ruby2.5}
          },
